...
def send_test_email_with_pdf(sample):
    ...
    msg.attach(MIMEText(
        ...
        <p>This quote was generated by our test portal and is not valid.<br>To get an accurate quote please email sales@dtgpower.com<br>We will let you know when the portal is live and ready for quotes. </p>
